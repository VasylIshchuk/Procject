...
public class Segment implements Shape {
    ...
    //    Constructor. Defines the points for a segment.
    public Segment(Vec2 point1, Vec2 point2) {
        this.point1 = point1;
        this.point2 = point2;
    }

    //    Getters used for creating a square.
    ...
    //    Creates an SVG for a segment.
    public String toSvg(String parameter) {
        //        To set the color to black by default if none is provided, and automatically set the width
        if (!parameter.contains("stroke=")) parameter += " stroke=\"black\" ";
        return String.format(Locale.ENGLISH, "\t<line x1=\"%f\" y1=\"%f\" x2=\"%f\" y2=\"%f\" %s/>",
                point1.x, point1.y, point2.x, point2.y, parameter);
        //        Make sure to add the "parameter" at the end, as this is where decorators (like solid, stroke, etc.) are appended.
    }

    //    Used for creating a square.
